...
```
Task(
  prompt="Read /Users/sharan_98/Desktop/procureguard-ai/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/sharan_98/Desktop/procureguard-ai/.codex/get-shit-done/templates/SECURITY.md`
