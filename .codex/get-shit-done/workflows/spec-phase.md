...
```bash
INIT=$(node "/Users/sharan_98/Desktop/procureguard-ai/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/sharan_98/Desktop/procureguard-ai/.codex/get-shit-done/templates/spec.md.
